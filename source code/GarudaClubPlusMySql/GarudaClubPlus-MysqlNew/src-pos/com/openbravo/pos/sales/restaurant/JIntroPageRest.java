...
public class JIntroPageRest extends JTicketsBag implements CardSwipeNotifier {
    ...
    private void checkToCreateSharedTicket(CustomerInfoExt ac_cust, String id, String ac_place, String ac_waiter, String ac_floor, String pfid, Double amount, Double limit, String mid, String fid, Date cdate) throws HeadlessException, BasicException{
        ...
        Object[] objctotal = null;
        Object[] limittotal = null;
        Object[] limittotal5 = null;
        double totalDebtAmount = 0.0;
        double totalCreditAmount = 0.0;
        Object[] objtotal1=null;
        Double addmnt=0.0;
        
          
          
          double totallimitamount=0.0;
          
          
        //double totalDebCrd=0.0;
            ...
            if ((Boolean) obj[3] == true) {
                 ...
                 if(FacObj!=null){
                        ...
                        if(v5){
                                ...
                                objtotal = (Object[]) new StaticSentence(m_App.getSession(), "SELECT SUM(A.BALANCEAMOUNT) FROM ACCOUNTJOURNAL A,CUSTOMERS C WHERE C.ID=? AND C.ACCOUNT=A.ACCOUNTID AND TRANSTYPE='D' AND ACTIVE IS TRUE",
                                ...
                                objctotal = (Object[]) new StaticSentence(m_App.getSession(), "SELECT SUM(A.BALANCEAMOUNT) FROM ACCOUNTJOURNAL A,CUSTOMERS C WHERE C.ID=? AND C.ACCOUNT=A.ACCOUNTID AND TRANSTYPE='C' AND ACTIVE IS TRUE",
                                new SerializerWriteBasic(new Datas[]{Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(new Object[]{ac_cust.getId()});
                               ...
                               if (objtotal != null && objtotal[0] != null && limittotal != null && limittotal[0] != null) {
                                    ...
                                    if(objctotal!=null && objctotal[0]!=null ){
                                    totalCreditAmount = (Double) objctotal[0];
                                    }
                                  Double totalDebCrd=totalDebtAmount-totalCreditAmount;
                                  
                          //addded by shweta
                                   
                                  
                                 objtotal1 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT FROMDATE,TODATE,ADDAMOUNT FROM QTCR_LIMITAUTH WHERE CUSTOMER=? AND ACTIVE IS TRUE",
                                new SerializerWriteBasic(new Datas[]{Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.DOUBLE})).find(new Object[]{ac_cust.getId()});
                                 Date fromdate=new Date();
                                 Date todate=new Date();
                                 Date currentdate=new Date();
                                 if(objtotal1 !=null){
                                    fromdate     =(Date) objtotal1[0]; 
                                    todate       =(Date) objtotal1[1];
                                    addmnt       =(double) objtotal1[2];
                                    //limitAmount = (Double) limittotal[0];
                                   
                                    if(currentdate.after(fromdate) && currentdate.before(todate)){
                                   totallimitamount= limitAmount+addmnt;
                                    }
...
//                                    if(totalDebtAmount>=totalCreditAmount)
//                                        totalDebCrd=totalDebtAmount-totalCreditAmount;
//                                    else
//                                        totalDebCrd=totalCreditAmount-totalDebtAmount;
                                   
                                    
                                    
                                 
                                    if (totallimitamount > 0.0) {
                                        if (totalDebCrd >= totallimitamount) {
                                            JOptionPane.showMessageDialog(this, "This Member Crosses Debit Limit \r\n Total Amount : " + totalDebCrd + "\r\n Amount Limit : " + totallimitamount + " ", "Limit Reached", JOptionPane.WARNING_MESSAGE);
                                        } else {
                            ...
                            objtotal = (Object[]) new StaticSentence(m_App.getSession(), "SELECT IFNULL(SUM(A.BALANCEAMOUNT),0.00) FROM ACCOUNTJOURNAL A , CUSTOMERS C WHERE  C.ID=? AND C.ACCOUNT=A.ACCOUNTID  AND A.TRANSREF=?  AND TRANSTYPE='D' AND ACTIVE IS TRUE", 
                                new SerializerWriteBasic(new Datas[]{Datas.STRING , Datas.STRING }), new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(new Object[]{ac_cust.getId(), id});
                            
                            objctotal = (Object[]) new StaticSentence(m_App.getSession(), "SELECT IFNULL(SUM(A.BALANCEAMOUNT),0.00) FROM ACCOUNTJOURNAL A , CUSTOMERS C WHERE  C.ID=? AND C.ACCOUNT=A.ACCOUNTID  AND A.TRANSREF=?  AND TRANSTYPE='C' AND ACTIVE IS TRUE", 
                                new SerializerWriteBasic(new Datas[]{Datas.STRING , Datas.STRING }), new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(new Object[]{ac_cust.getId(), id});
                            
                            
                                    limittotal5 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT DEBTMAX FROM MEMTYPE WHERE ID=?",
                                         new SerializerWriteBasic(new Datas[]{Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(new Object[]{ac_cust.getMemtype()});
                                    
                                    limittotal = (Object[]) new StaticSentence(m_App.getSession(), "SELECT AMOUNTLIMIT FROM FACILITY WHERE ID=?",        
                                        new SerializerWriteBasic(new Datas[]{Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(new Object[]{id});
                                
                                 
                                 if (objtotal != null && objtotal[0] != null && limittotal != null && limittotal[0] != null && limittotal5[0]!=null) {
                                    totalDebtAmount = (Double) objtotal[0];
                                    if(objctotal!=null && objctotal[0]!=null  ){
                                    totalCreditAmount = (Double) objctotal[0];
                                    }
...
//                                        totalDebCrd=totalCreditAmount-totalDebtAmount;
                                    ...
                                    Double LimitAmount5 = (Double) limittotal5[0];
                                    
                                    
                                    System.out.println("Total Facility wise balance amt = "+totalDebtAmount);
                                    System.out.println("Total Limit  amt = "+limitAmount);
                                    if (limitAmount > 0.0) {
                                        if (totalDebCrd >= limitAmount) {
                                            JOptionPane.showMessageDialog(this, "This Member Crosses Debit Limit \r\n Total Amount : " + totalDebCrd + "\r\n Amount Limit : " + limitAmount + " ", "Limit Reached", JOptionPane.WARNING_MESSAGE);
                                        } else {
                                            if(totalDebCrd >= LimitAmount5){
                                                 JOptionPane.showMessageDialog(this, "This Member Crosses Debit Limit \r\n Total Amount : " + totalDebCrd + "\r\n Amount Limit : " + LimitAmount5 + " ", "Limit Reached", JOptionPane.WARNING_MESSAGE);
                                            }
                                            else{
                                                createSharedTicket(ac_cust, ac_place, ac_waiter, ac_floor);
                                            }
...
// Changes Done for billing member : :: #AAKASH
                 ...
                 //added by shweta  
                       ...
                       opb1=opb-addmnt1;
                         ...
                         opb1=opb-addmnt1;                          
                               ...
                               if(obj2==null){
                                new PreparedSentence(m_App.getSession(), " INSERT INTO billingmember(ID, OPB, CURROPB) values(?,?,?)", new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.DOUBLE, Datas.DOUBLE})).exec(new Object[]{id,opb,opb1});
                                }
                                if(guestlist.getSelectedIndex()>=0){
                                ...
                                if(objg==null){
                                    new PreparedSentence(m_App.getSession(), "INSERT INTO billingmember(ID, OPB, CURROPB) values(?,?,?)", new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.DOUBLE, Datas.DOUBLE})).exec(new Object[]{customername,opb,opb1});
                                    }
                                }
...
//    }
        ...
        try {
            ...
            //            }
                ...
                if (!portNumber.isEmpty() && portValue.isEmpty()) {
                    ...
                    card = cd.getCardNumber();// Exception
                    if (card == null || card.length() <= 0) {
                        //JOptionPane.showMessageDialog(this, "Please swipe a card");
                        //praveen:added to request authorisation for creation of  shared ticket----start
                        if (JOptionPane.showConfirmDialog(this, "If ur card is not issued, click YES to 'Send for Authorisation' OR \r\n if issued swipe a valid card", "invalid card", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
    ...
    private void initComponents() {
        ...
        jButton11.setForeground(new java.awt.Color(21, 84, 250));
        jButton11.setText("Update QT/Bill");
        ...
        photo_button.setText("View Photos");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(photo_button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())))
        );
...
private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField3ActionPerformed
    ...
    try {
       Object[] obj = (Object[]) new StaticSentence(m_App.getSession(), "SELECT C.ID,C.SEARCHKEY,C.NAME,M.CARD,M.ID  FROM CUSTOMERS C,MEMDEPENDENT M WHERE M.MEMNO=C.ID AND M.CARD=? AND C.VISIBLE=TRUE UNION ALL  SELECT C.ID,C.SEARCHKEY,C.NAME,C.CARD,C.ID  FROM CUSTOMERS C WHERE C.CARD=? AND C.VISIBLE=TRUE",               // #CHANGE BY AAKASH... ON 6TH DEC 2013
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
       QT_Bill_UpdateMenuNew memList;
        try {
            memList = QT_Bill_UpdateMenuNew.getDialog(this, m_App,true,1);
            memList.showDialog();
//////               
        } catch (BasicException ex) {
            Logger.getLogger(QT_Bill_UpdateMenuNew.class.getName()).log(Level.SEVERE, null, ex);
        }
...
public long startSec = 0;
    ...
    private void photo_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_photo_buttonActionPerformed
       if(customer!=null){
           String MemberNo = customer.getSearchkey();
           String MemberName = customer.getName();
 ...
 // code to update qt and bill .....................................   
    ...
    // CODE TO LOAD SHARED TICKET FROM ANDROID APP 
    
    public List<String> STidsList = new ArrayList<String>();
    
    public void getAndroidSharedTicket(){
         ...
         Transaction t = new Transaction(m_App.getSession()) {                                                                                     
                        ...
                        protected Object transact() throws BasicException {
                            ...
                            STidsList = new ArrayList<String>();
                            STidsList = getSharedTickListFromApp(m_App);
                            String id , cid = null,name,counter = null , initiator =null , waiterid = null,floorid = null ,placeid = null;
                            int type;
                            for(int i=0;i<STidsList.size();i++){
                                String CurrID = STidsList.get(i).toString();
                                if(CurrID!=null){
                                  Object[] obj = (Object[]) new StaticSentence(m_App.getSession(), 
                                          "SELECT id , cid , name , counter , initiator , type , waiterid , floorid , placeid from sharedticketapp where id=?",
                                           SerializerWriteString.INSTANCE, 
                                          new SerializerReadBasic(new Datas[]{Datas.STRING , Datas.STRING , Datas.STRING , Datas.STRING , Datas.STRING , Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING})).find(CurrID);  
                                    if(obj!=null){
                                        if(obj[0]!=null){
                                            id = obj[0].toString();
                                        }
                                        ...
                                        if(obj[3]!=null){
                                            counter = obj[3].toString();
                                        }
                                        if(obj[4]!=null){
                                            initiator = obj[4].toString();
                                        }
                                        if(obj[5]!=null){
                                            type = Integer.parseInt(obj[5].toString());
                                        }
                                        if(obj[6]!=null){
                                            waiterid = obj[6].toString();
                                        }
                                        if(obj[7]!=null){
                                            floorid = obj[7].toString();
                                        }
                                        if(obj[8]!=null){
                                            placeid = obj[8].toString();
                                        }


                                       TicketInfo m_oTicket =  new TicketInfo();

                                       m_oTicket.setCustomer(dlCustomers.getCustomerByID(cid));
                                       m_oTicket.setPlace(dlSales.getPlaceByID(placeid));
                                       m_oTicket.setWaiter(dlSales.getWaiterByID(waiterid));
                                       m_oTicket.setFloor(dlSales.getFloorByID(floorid));

                                       int count = dlReceipts.checkSharedTicket(cid, m_oTicket,counter );
                                       if (count == 0) { 

                                        dlReceipts.insertSharedTicket(cid, m_oTicket, counter, initiator, 0);



                                       new PreparedSentence(m_App.getSession()
                                            , "delete from  sharedticketapp where id= ?"
                                            , new SerializerWriteBasic(new Datas[]{Datas.STRING})).exec(new Object[]{CurrID});
                            ...
                            if(FacObj!=null){
                                 Boolean v5 = (Boolean)FacObj[0];
                                 if(v5){
                                                Object[] obj5 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ACCOUNT FROM CUSTOMERS where ID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(cid);
                                                String aid = obj5[0].toString();
                                                Object[] obj1 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ((OBDEBIT+CURDEBIT)-(OBCREDIT+CURCREDIT)) FROM trailbalance where ACCOUNTID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(aid);
                                                 String opbs = obj1[0].toString();
                                                 Double opb = new Double(opbs);
                                                 Double opb1=opb;
                                                 ...
                                                 Object[] objstotal1 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT FROMDATE,TODATE,ADDAMOUNT FROM QTCR_LIMITAUTH WHERE CUSTOMER=? AND ACTIVE IS TRUE",
                                        new SerializerWriteBasic(new Datas[]{Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.TIMESTAMP,Datas.TIMESTAMP,Datas.DOUBLE})).find(new Object[]{cid});
                              Date fromdate=new Date();
                               Date todate=new Date();
                             Date currentdate=new Date();
                                double addmnt1=0.0;
                       ...
                       opb1=opb-addmnt1;
                         ...
                         opb1=opb-addmnt1;                          
                                                ...
                                                Object[] obj2 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ID FROM billingmember where ID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(cid);
                                                
                                                if(obj2==null){
                                                new PreparedSentence(m_App.getSession(), " INSERT INTO billingmember(ID, OPB, CURROPB) values(?,?,?)", new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.DOUBLE, Datas.DOUBLE})).exec(new Object[]{cid,opb,opb1});
                                                }
                                                if(guestlist.getSelectedIndex()>=0){
                                                    Object[] objg = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ID FROM billingmember where ID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(cid);
                                                if(objg==null){
                                                    new PreparedSentence(m_App.getSession(), "INSERT INTO billingmember(ID, OPB, CURROPB) values(?,?,?)", new SerializerWriteBasic(new Datas[]{Datas.STRING,Datas.DOUBLE, Datas.DOUBLE})).exec(new Object[]{cid,opb,opb1});
                                                    }
                                                }
                                            ...
                                            if (obj5 != null) {
                                             ...
                                             Object[] obj5x = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ACCOUNT FROM CUSTOMERS where ID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(cid);
                                             String aid = obj5x[0].toString();
                       ...
                       opb1=opb-addmnt1;
                         ...
                         opb1=opb-addmnt1;                          
                                ...
                                Object[] obj6x = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ACCOUNT FROM CUSTOMERS where ID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(cid);
                                String aid = obj6x[0].toString();
                                Object[] obj1 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT ((OBDEBIT+CURDEBIT)-(OBCREDIT+CURCREDIT)) FROM trailbalance where ACCOUNTID=?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.DOUBLE})).find(aid);
                                 String opbs = obj1[0].toString();
                                 Double opb = new Double(opbs);
                             Double opb1=opb;
    ...
    public List getSharedTickListFromApp(AppView app ) throws BasicException{
           List<Object> ShardID = new ArrayList<Object>();
           ShardID  = (List<Object>) new StaticSentence(app.getSession(), "SELECT id from  sharedticketapp ",  SerializerWriteString.INSTANCE , SerializerReadString.INSTANCE).list();
    ...
    // for more no of pending bills 
    
    
     List<String> PendingBillsWarehouseList = new ArrayList<String>();
     List<String> UserWarehouseList = new ArrayList<String>();
     
     Double PendingBillsAmount = 0.00;
     Double AmountLimit = 0.00; 
     
     int NoOfPendingBillsHours = 0;
     Date PendingBillCheckDate = new Date();
     
     
   public Boolean DeactivationOfMemberForPendingBills() throws BasicException{
       Boolean PendingBillsAllow = false; 
      if(customer!=null){ 
        
        AmountLimit = 0.00; 
       PendingBillsAmount= 0.00;
   
      Object[] obj = (Object[]) new StaticSentence(m_App.getSession(), "SELECT VALUE FROM generaltable  where NAME='Pending Bills Deactivation Flag'", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.BOOLEAN})).find();
       if(obj!=null){
        Boolean v = (Boolean)obj[0];
        if(v==true){
            Object[] obj2 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT VALUE FROM generaltable  where NAME='Pending Bill Limits Amount'", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find();
            if(obj2!=null){
                if(obj2[0]!=null){
                    // no of pending bills   
                    AmountLimit = Double.parseDouble(obj2[0].toString());
                    PendingBillsWarehouseList = new ArrayList<String>();
                    Object[] obj7 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT VALUE FROM generaltable  where NAME='Pending Bills Time In Hours'", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find();
                    if(obj7!=null){
                        if(obj7[0]!=null){
                             NoOfPendingBillsHours = Integer.parseInt(obj7[0].toString());
                             Calendar cal = Calendar.getInstance();
                             cal.setTime(new Date());
                             cal.add(Calendar.HOUR, (-1)*NoOfPendingBillsHours);
                             PendingBillCheckDate = cal.getTime();   
                        }
                    ...
                    // warehouse 
                     Object[] obj6 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT VALUE FROM generaltable where NAME='Pending Bills Warehouse'", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find();
                        if(obj6!=null){
                            String AllFac = obj6[0].toString();
                            if(AllFac.equals("ALL")){
                               PendingBillsWarehouseList.add("ALL");
                                ...
                                for(int i=0;i<fac.length;i++){
                                    ...
                                    PendingBillsWarehouseList.add(f1);
                                 } 
                            ...
                            PendingBillsAllow = true;
                        }
                         
                    if(PendingBillsWarehouseList.size()>0){
                        if(PendingBillsWarehouseList.contains("ALL")){
                            
                             Object[] obj3 = (Object[] ) new StaticSentence(m_App.getSession(), "select id , customer , warehouse  , sum(amount+taxtotal)  from bill where paid=0\n" +
                                                                                            " and customer=?  and createddate < ?   \n" +
                                                                                            "having sum(amount+taxtotal) > ?  \n" +
                                                                                            "order by 2",  new SerializerWriteBasic(new Datas[]{ Datas.STRING , Datas.TIMESTAMP,  Datas.DOUBLE   }), new SerializerReadBasic(new Datas[]{  Datas.STRING , Datas.STRING , Datas.STRING , Datas.INT }))
                                                                                    .find(new Object[]{customer.getId() ,PendingBillCheckDate  , AmountLimit   } );
                                    if(obj3!=null){
                                        
                                        PendingBillsAmount = Double.parseDouble(obj3[3].toString());
                                        PendingBillsAllow = false;
                            ...
                            List<String> FinalWarehouseList = new ArrayList<String>(PendingBillsWarehouseList);
                           
                        //    FinalWarehouseList.retainAll(UserWarehouseList);
                        //because the size was varying.
                         FinalWarehouseList.retainAll(PendingBillsWarehouseList);
                            //FinalWarehouseList=PendingBillsWarehouseList;//added by pratima
                            System.out.println( "FinalWarehouseList size"+FinalWarehouseList.size());
                            
                            
                            if(AmountLimit!=0.00){
                                if(FinalWarehouseList.size()>0){
                                
                              //      for(int i=0;i<FinalWarehouseList.size();i++){
                               //         String warehousetemp = FinalWarehouseList.get(i).toString();
                            //used iterator because iterator has good performance as compared to for loop and foreach loop.
                                Iterator i=FinalWarehouseList.iterator();
                                while(i.hasNext())
                                {
                                    String warehousetemp=i.next().toString();
                                       // List<Object[]> obj3 = (List<Object[]>) new StaticSentence(m_App.getSession(), "select id , customer , warehouse , count(*) as cnt from bill where paid=0  and warehouse=?  and customer=?   \n" +
                                                                  //                                          "group by customer , warehouse\n" +
                                                                    //                                        "having cnt>  ?  \n" +
                                                                    //                                        "order by 2",  new SerializerWriteBasic(new Datas[]{Datas.STRING , Datas.STRING ,  Datas.INT }), new SerializerReadBasic(new Datas[]{  Datas.STRING , Datas.STRING , Datas.STRING , Datas.INT })).list(new Object[]{warehousetemp ,customer.getId() , NoOfPendingBills    } );
                                                                    
                                    /*    Object[] obj3 = (Object[] ) new StaticSentence(m_App.getSession(), "select id , customer , warehouse  , sum(amount+taxtotal)  from bill where paid=0   \n" +
                                                                                                        " and customer=?   and warehouse= ?  and createddate < ?  \n" +
                                                                                                        "having sum(amount+taxtotal) > ?  \n" +
                                                                                                        "order by 2",  new SerializerWriteBasic(new Datas[]{Datas.STRING , Datas.STRING ,Datas.TIMESTAMP ,  Datas.DOUBLE }), new SerializerReadBasic(new Datas[]{  Datas.STRING , Datas.STRING , Datas.STRING , Datas.INT }))
                                                                                                    .find(new Object[]{customer.getId() , warehousetemp ,PendingBillCheckDate, AmountLimit    } );
                                     */  
                               
                                    //By pratima  - above query updated because pending bill limit check was not performing for Cr. Confirmation entries. 
                                    //The updated query is below :
//                                    Object[] obj3 = (Object[] ) new StaticSentence(m_App.getSession(), "select id , customer , warehouse  , sum(amount+taxtotal)  from bill where receipt is null   \n" +
//                                                                                                        " and customer=?   and warehouse= ?  and createddate < ?  \n" +
//                                                                                                        "having sum(amount+taxtotal) > ?  \n" +
//                                                                                                        "order by 2",  new SerializerWriteBasic(new Datas[]{Datas.STRING , Datas.STRING ,Datas.TIMESTAMP ,  Datas.DOUBLE }), new SerializerReadBasic(new Datas[]{  Datas.STRING , Datas.STRING , Datas.STRING , Datas.INT }))
//                                                                                                    .find(new Object[]{customer.getId() , warehousetemp ,PendingBillCheckDate, AmountLimit    } );
            ...
            PendingBillsAllow = true;
            System.out.println("Deactivation is disabled...");
        } 
       }
       else{
           System.out.println("Deactivation is disabled...");
           ...
           JOptionPane.showMessageDialog(this, AppLocal.getIntString("message.Please select member first"), AppLocal.getIntString("message.custtitle"), JOptionPane.WARNING_MESSAGE);
      }
      
      return PendingBillsAllow ;
   }  
    
    
      
   
   public void getUserWarehouseList(){
       
        UserWarehouseList = new ArrayList<String>();
        try{           
            // warehouse 
            System.out.println("user id "+m_App.getAppUserView().getUser().getId());
            Object[] obj6 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT prcategories FROM people  where ID= ?  and visible=true ", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(m_App.getAppUserView().getUser().getId());
            if(obj6!=null){
                String AllFac = obj6[0].toString();
                if(AllFac.equals("ALL")){
                   UserWarehouseList.add("ALL");
                }
                else{
                String[] fac = AllFac.split("#");
                for(int i=0;i<fac.length;i++){
                    String f1 = fac[i].toString();
                    UserWarehouseList.add(f1);
                    } 
                }
            }
             //added by pratima
            else{
                obj6 = (Object[]) new StaticSentence(m_App.getSession(), "SELECT prcategories FROM people  where role= (SELECT counter from waiter where id=?) ", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.STRING})).find(m_App.getAppUserView().getUser().getId());
                ...
                if(obj6!=null){
                    ...
                    if(AllFac.equals("ALL")){
                     ...
                     for(int j=0;j<obj6.length;j++){
                        AllFac = obj6[j].toString();
                        String[] fac = AllFac.split("#");
                        for(int i=0;i<fac.length;i++){
                            String f1 = fac[i].toString();
                            UserWarehouseList.add(f1);
